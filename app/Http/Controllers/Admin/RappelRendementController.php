...
class RappelRendementController extends Controller
{
    public function index(Request $request)
    {
        ...
        //dd($adms_select);
        return view('admin/rappel_rendement/employees-list', [
            "employees" => $employees,
            "adms" => $adms,
...

    {
        ...
        return view('admin/rappel_rendement/list', ["raprend_singles" => $raprend_singles, "employee" => $employee]);
    }
    ...
    public function rappel_rendement_print(Request $request)
    {
        ...
        */
        ...
        //dd($raprend);
        $mpdf->viewToPDF('admin/rappel_rendement/pdf-raprend', ["raprend" => $raprend, "serv" => []]);
