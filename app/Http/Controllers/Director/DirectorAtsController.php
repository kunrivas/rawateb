...
class DirectorAtsController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        //dd($adms_select);
        return view('director/ats/employees-list', ["employees" => $employees, "adms" => $adms, "select_adms" => $select_adms, "select_sitpai" => $select_sitpai, "search" => $search]);
    }
    ...
    public function ats_single_list($MATRI)
    {
        ...
        return view('director/ats/list', ["employee" => $employee]);
    }
    ...
    function ats_single_print(Request $request)
    {
        ...
        if ($request->clicked === "page1") {
            ...
            return view('ats/ats-page1', $data);
        }
 ...
 */
            ...
            return view('director/ats/ats-page2', $data);
        }
