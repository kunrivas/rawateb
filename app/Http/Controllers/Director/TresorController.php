...
class TresorController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $adms = adm::all();
        $select_adms = [];
        $select_sitpai = [1, 2, 3, 4, 5];
        // 🚫 NO search → EMPTY table
        if (!$request->filled('search')) {
            $employees = employee::whereRaw('1 = 0')->paginate(12);

            return view('director/tresor/employees-list', compact(
                'employees',
                'adms',
                'select_adms',
                'select_sitpai',
        ...
        //dd($adms_select);
        return view('director/tresor/employees-list', ["employees" => $employees, "adms" => $adms, "select_adms" => $select_adms, "select_sitpai" => $select_sitpai, "search" => $search]);
    }
...

    {
        ...
        return view('director.tresor.estab-employees-list', compact('employees', 'estabName'));
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('director/tresor/edit', ["employee" => $employee, "adms" => $adms]);
    }
    ...
    public function print(Request $request)
    {
        ...
        // dd($view_data);
        // dd($view_data);
        $mpdf->viewToPDF('director/tresor/pdf-print', ['employees' => $employees, 'establishment' => $establishment, "phone" => $request->phone]);
    ...
    public function stat(Request $request)
    {
        ...
        $estabsEnded = $stats->where('total', '=', 'nin_not_empty')->count();
        ...
        return view('director.tresor.establishment-list', compact('stats', 'totalEstabs', 'estabsEnded', 'totalEmployees', 'totalRegistered', 'estabsStarted', 'estabsNotStarted'));
    }
    ...
    public function exportTresorToExcel()
    {
        ...
        return view("director.tresor.export-excel", [
