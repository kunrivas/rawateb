...
class AtsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //dd($adms_select);
        return view('ats/employees-list', ["employees" => $employees, "adms" => $adms, "select_adms" => $select_adms, "select_sitpai" => $select_sitpai, "search" => $search]);
    ...
    public function ats_single_list($MATRI)
    {
        ...
        return view('ats/list', ["employee" => $employee]);
    }
 ...
 */
            ...
            return view('ats/ats-page2', $data);
        }
