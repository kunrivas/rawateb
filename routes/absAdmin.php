...
Route::group(['prefix' => '', 'middleware' => env("APP_ENV", "local") == "local" ? [] : ['role:abs-admin']], function () {
...
Route::post('absence/login', [App\Http\Controllers\Absence\AbsenceLoginController::class, 'login'])->name("post-absence-login");
