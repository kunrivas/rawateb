...
{{-- linked by yield in parent view --}}
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#">كشف مخلف المردودية </a></li>
    ...
    <div class="row">
        <div class="col">
            <div class="mt-4">
                ...
                <form method="post" action="{{ route('rappel-rendement-single-employees') }}">
                    @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex justify-content-center ml-2 ">
                                        <a href="{{ route('rappel-rendement-single-list', ['MATRI' => $employee->MATRI]) }}"
                                            class="btn text-white btn-primary  ml-2">كشف مخلف المردودية </a>
