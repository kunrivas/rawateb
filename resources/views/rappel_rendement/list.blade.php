                    ...
                    @foreach ($raprend_singles as $raprend_single)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('rappel-rendementt-single-print') }}" method="post" target="_blank">
                                    ...
                                    <input type="hidden" name="ID_MEGRATION_RA_RE" value="{{ $raprend_single->ID_MEGRATION_RA_RE }}">
                                    ...
                                    <button type="submit" class="btn text-white btn-primary">  طباعة كشف  مخلف المردودية </button>
