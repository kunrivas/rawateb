...
@section('content-title')
    <h1> كشف المخلف الجماعي
    </h1>
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#">كشف مخلف</a></li>
    ...
    <div class="row">
        <div class="col">
            <table class="table table-striped ">
                ...
                <tbody>
                    @foreach ($ra_megrations as $ra_megration)
                        <tr>
                            <td>{{ $ra_megration->YEAR }}</td>
                            <td>
                                {{ $ra_megration->TITLE ?? '/' }}
                            </td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu  dropdown-menu-bottom" role="menu" style="">
                                        ...
                                        <form class="dropdown-item" style="padding: 0;" target="_black"
                                                    action="{{ route('rappel-global-print') }}" method="post">
                                                    @csrf
                                                    <input type="hidden" name="ID_MEGRATION_RA"
                                                        value="{{ $ra_megration->ID_MEGRATION_RA }}">
