...
@section('contents')
    <div class="row">
        ...
        <div class="col">
            <a href="{{ route('tresor-print') }}" class="btn btn-success col-2 ml-2" target="_blank">
                <i class="fa fa-print"></i> طباعة القائمة الإجمالية
            </a>
            <div class="mt-4">

                <form method="post" action="{{ route('tresor-list') }}">
                    @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex justify-content-center ml-2 ">
                                        ...
                                        <a type="submit" href="{{ route('tresor-edit', $employee->MATRI) }}"
