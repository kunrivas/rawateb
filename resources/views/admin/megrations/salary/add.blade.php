...
@section('title')
    إضافة الحزم الاجر الشهري
@endsection
@section('content-title')
    <h1></h1>
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#"> إضافة حزمة الاجر الشهري</a></li>
    <li class="breadcrumb-item"><a href="{{ route("admin-megration-salary-index") }}">الاجر الشهري</a></li>
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">إضافة الحزم الاجر الشهري جديدة</h3>
                </div>


                <form action="{{ route('admin-megration-salary-store') }}" method="POST"  enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
