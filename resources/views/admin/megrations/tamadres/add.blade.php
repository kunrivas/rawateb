...
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#"> إضافة حزمة التمدرس</a></li>
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">إضافة حزم تمدرس جديدة</h3>
                </div>


                <form action="{{ route('admin-megration-tamadres-store') }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-drop-area">
                                ...
                                <input class="file-input" type="file" name="ta_megration" required>
                            </div>
                        </div>
                    </div>
