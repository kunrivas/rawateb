...
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#"> إضافة حزمة المردودية</a></li>
    <li class="breadcrumb-item"><a href="{{ route('admin-megration-salary-index') }}">المردودية</a></li>
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">إضافة الحزم مردودية جديدة</h3>
                </div>


                <form action="{{ route('admin-megration-rendement-store') }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control" name="TRIMESTRE" required>
                                ...
                                @for ($rendement = 1; $rendement <= 4; $rendement++)
                                    <option value="{{ $rendement }}">
                                        {{ Mlibrary::getRendament($rendement) }}
                                    </option>
                                @endfor
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-drop-area">
                                ...
                                <input class="file-input" type="file" name="re_megration" required>
                            </div>
                        </div>
                    </div>
