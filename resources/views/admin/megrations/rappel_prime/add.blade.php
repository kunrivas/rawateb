...
@section('title')
    إضافة حزمة  مخلف مردودية
@endsection
@section('content-title')
    <h1></h1>
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#">  إضافة  حزمة مخلف مردودية</a></li>
    <li class="breadcrumb-item"><a href="{{ route("admin-megration-rappel-prime-index") }}">المخلفات </a></li>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="card">
                ...
                <form action="{{ route('admin-megration-rappel-prime-store') }}" method="POST"  enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
