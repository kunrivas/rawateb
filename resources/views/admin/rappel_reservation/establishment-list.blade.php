...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="#"> تسير حجز المخلفات</a></li>
@endsection
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">العدد المؤسسات</span>
    ...
    <div class="row mb-1">
        <div class="col">
            ...
            <form method="post" class="row"
                action="{{ route('admin-rappels-establishments', $rappel_reservation->rappel_reservation_id) }}">
                @csrf
        ...
        <div class="col d-flex justify-content-end">
            <a class="btn btn-danger btn-sm text-white mx-2 " style="    height: fit-content;            "
                href="{{ route('admin-rappels-in-establishments', $rappel_reservation->rappel_reservation_id) }}">قائمة المؤسسات التي لم
                تحجز
            </a>
        </div>
    ...
    <div class="row">
        <div class="col">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach ($rappel_reservationsStatistics as $rappel_reservationsStatistic)
                        @if ($rappel_reservationsStatistic->establishment)
                            <tr>


                                <td>
                                    {{ $rappel_reservationsStatistic->establishment->estab_rawateb_user }}
                                </td>
                                <td>
                                    {{ $rappel_reservationsStatistic->establishment->estab_ar_name }}
                                </td>
                                <td>

                                    @if ($rappel_reservationsStatistic->status)
                                ...
                                <td>
                                    {{ $rappel_reservationsStatistic->reserved }}
                                </td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" role="menu" style="">
                                            <a class="dropdown-item font-weight-bold"
                                                href="{{ route('admin-rappels-establishments-employees', $rappel_reservationsStatistic->id) }}">معاينة</a>
            ...
            {{ $rappel_reservationsStatistics->appends(request()->input())->links() }}
