    ...
    <div class="row">
        <div class="col">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th class="col-md-4" scope="col">السنة</th>
                        <th class="col-md-4" scope="col">الشهر</th>
                        <th class="col-md-4" scope="col">لغة كشف الراتب</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($salary_singles as $year => $salary_single)
                            ...
                            <div class="responsive v-responsive months" id="months-{{ $year }}">
                                <table class="table  table-responsive table-bill-global ">
                                    ...
                                    <tbody>
                                        ...
                                        @if (!empty($salary_single))
                                            @foreach ($salary_single as $month => $salary_single)
                                                <tr>
