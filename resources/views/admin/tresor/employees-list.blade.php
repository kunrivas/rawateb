    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="mt-4">
                ...
                <form method="post" action="{{ route('admin-tresor-list') }}">
                    @csrf
            ...
            <a class="btn btn-success btn-sm text-white mx-2" style="height: fit-content;"
                href="{{ route('admin-tresor-excel') }}" target="_blank" rel="noopener noreferrer">
                تصدير إلى Excel
            </a>

            <a class="btn btn-danger btn-sm text-white mx-2 " style="    height: fit-content;            "
                href="{{ route('admin-tresor-sql') }}">تصدير الى sql
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex justify-content-center ml-2 ">
                                        ...
                                        <a type="submit" href="{{ route('admin-tresor-edit', $employee->MATRI) }}"
