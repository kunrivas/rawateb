...
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#"> إضافة ثلاثي جديد </a></li>
    <li class="breadcrumb-item"><a href="#"> قائمة المردودية </a></li>
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> إضافة ثلاثي جديد </h3>
                </div>


                <form action="{{ route('admin-rendement-store') }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control" name="TRIMESTRE" required>
                                ...
                                @for ($rendoment = 1; $rendoment <= 4; $rendoment++)
                                    <option value="{{ $rendoment }}">{{ Mlibrary::getRendament($rendoment) }}
                                    </option>
                                @endfor
