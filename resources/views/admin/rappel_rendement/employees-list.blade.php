    ...
    <div class="row">
        <div class="col">
            <div class="mt-4">
                ...
                <form method="post" action="{{ route('admin-rappel-rendement-single-employees') }}">
                     @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex justify-content-center ml-2 ">
                                        <a href="{{ route('admin-rappel-rendement-single-list', ['MATRI' => $employee->MATRI]) }}"
                                            class="btn text-white btn-primary  ml-2">عرض </a>
