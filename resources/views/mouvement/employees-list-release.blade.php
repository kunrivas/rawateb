...
{{-- linked by yield in parent view --}}
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="#">تحرير موظف</a></li>
@endsection
@section('css')
    <style>
        .form-check {
    ...
    <div class="row">
        <div class="col">
            <div class="mt-4">
                ...
                <form method="post" action="{{ route('mouvement-employees-list-release') }}">
                    @csrf
                    ...
                    <tbody>
                        @foreach ($employees as $employee)
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('mouvement-employees-release', $employee->id) }}"
                                        onsubmit="return confirm('هل أنت متأكد أنك تريد تحرير هذا الموظف؟');">
                                        @csrf
